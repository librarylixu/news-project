...
*/
namespace Model;
class mCustomerlogModel extends baseModel{
   var $db;//数据库对象   
   var $mongo;
   var $tb;//当前表
    ...
    */
	function table_colunms_function(){    
		$arr= array(
				...
				type=>array(value=>'int',"description"=>"表示当前做的什么操作：0：添加 1：修改  2：删除 4 查询"),
                customerid=>array(value=>'int',"description"=>"添加成功后，客户的id"),
