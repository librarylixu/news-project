...
//主控制器
appModule.controller('crmLoginlogController', ['$scope', '$q', 'dataService', 'textAngularManager', function ($scope, $q, dataService, textAngularManager) {
    _$scope = $scope;
    _$q = $q;    
    ...
    */
    $scope.select = function (where) {
        ...
        $scope.service.postData(__URL + 'Crmlog/Loginlog/select_page_data', params).then(function (data) {
            //总条数
            ...
            $scope.service.loginLogData = data.data;
            //查询其他展示的数据
            $scope.selectother();
        });
    }
