...
var dataLanguage = {   
    ...
    "sProcessing": "处理中...",
    "sInfo": "第 _PAGE_ 页(共 _PAGES_ 页,_TOTAL_条数据) _START_ / _END_",
    "sSearch": "快速查询:",
    "sEmptyTable": "表中数据为空",
    "sLoadingRecords": "载入中...",
    "sInfoThousands": ",",
...
//表格显示行数选项，根据配置{$_SESSION['PagedataCount']}设置初始值
var _dt_lengthMenu = [[10, 20, 50, 100], [10, 20, 50, 100]];
if (_dt_lengthMenu[0].indexOf(_dt_pagelength) <= -1) {
    _dt_lengthMenu[0].push(_dt_pagelength);
    _dt_lengthMenu[1].push(_dt_pagelength);
}
