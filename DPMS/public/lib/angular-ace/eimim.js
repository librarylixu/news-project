/*
手册:http://www.layui.com/doc/modules/layim.html

功能演示:http://www.layui.com/demo/layim.html
...
layui.use('layim', function (layim) {
   // var layim = layui.layim;
    ...
    layim.config({
        //初始化接口
        init: {
            //'//layim.layui.com/json/getList.json'
            url: 'Webim/getusers'
          , data: {}
        }
        //查看群员接口
      , members: {
          ////layim.layui.com/json/getMembers.json
          url: 'Webim/getmembers'
        , data: {}
      }
      , uploadImage: {
          url: '' //（返回的数据格式见下文）
