  ...
  YL.vue = new Vue({
    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        //  YL.onReady(function () {
        //    setTimeout(function () {
        //        YL.msg("YLUI v" + YL.info.version + " 社区版", '当前YLUI为社区版，仅限个人用户学习使用，禁止商用及企业使用。<br/>更多信息及获取商业授权请访问:<br/>YLUI官网：' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn">https://ylui.yuri2.cn</a><p>欢迎使用支付宝扫描二维码对作者进行捐赠，表达您对YLUI的支持~<br/><br/><img style="width: 100%" src=__win10uiUrl + "res/img/donation.png"/></p>');
        //    }, 1500)
        //  });
        //}
      ...
      winContextMenu: function (id, e) {
        ...
        //上一步
        menu.push([YL.util.getStrFa("reply") + YL.lang("Laststep"), function () {
      ...
      desktopClick: function (e) {
        ...
        /*
            这个地方配置了右键的属性值   配置的文件如：<DisplayDesktop>在 langs/zh-cn.json
            getStrFa  图标
        */
      desktopContextMenu: function (e) {
        ...
        var menu = [
             //公告板
          [YL.util.getStrFa("bullhorn") + YL.lang("Bulletin"), function () {
              YL.open('bulletin');
          }],
            //刷新
          [YL.util.getStrFa("refresh") + YL.lang("Refresh"), function () {
          ...
          //  YL.open('yl-system')
          //}, !YL.static.changeable],
          //修改密码    '/index.php/Crmuser/Users/editpwdpage', '<i class="fa fa-edit icon red"></i>修改登录密码', [['350px', '220px']]
          [YL.util.getStrFa('lock') + YL.lang("UpdatePassword"), function () {
              YL.open(
                        {
                            title: '修改登录密码',
                            url: '/index.php/Crmuser/Users/editpwdpage',
                            size: {
                                width: '350',
                                height: '220'
                            },
          ...
          //测试页面，仅供自己使用，部署模式隐藏此页面
          [YL.util.getStrFa('firefox') + YL.lang("Author"), function () {
              YL.open(
                        {
                            title: '调试页面，仅供开发人员使用',
                            url: '/index.php/Home/Index/session',
                            size: {
                                width: '350',
                                height: '220'
                            },
          ...
          //安全退出
          [YL.util.getStrFa('sign-out') + YL.lang("Loginout"), function () {
              //调用安全退出方法
              window.location.href = '/index.php/Home/Login/logout';
              //YL.f5();
          }],
          '|',
          //关于
