window.YL = {
  info: {
    ...
    officialWebsite: 'https://www.qhoa.net',
    copyrightDetail: 'CRM已经进入到二期的工作中',
  },
  data: {},
  lang: function (key) {
  ...
  _baseData: function () {
    return {
      ...
      configs: {
        ...
        sound: false,//开启声音
        wallpaper: __win10uiUrl + 'res/img/wallpapers/bg1.jpg',
...
YL.util.onloadSafe(function () {
    YL.util.loadScript(__win10uiUrl + 'configs.js', function () {
    ...
    YL.util.loadContentFromUrl(__win10uiUrl + 'langs/' + YL.static.lang + '.json', 'GET', function (err, text) {
      if (!err) {
